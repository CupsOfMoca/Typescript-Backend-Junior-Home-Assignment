### Solution for the assigmnet: Typescript Backend (junior) - Home Assignment
#### Made by Bence Török

I used MongoDB for the database.

I provided a postman collection for testing the endpoints. (id's will most likely need to be adjusted)
